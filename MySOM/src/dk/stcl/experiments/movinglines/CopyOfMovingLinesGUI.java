...
public class CopyOfMovingLinesGUI extends JFrame {
	private SimpleMatrixVisualizer input;
	private SomPanel spatialModels;
	private SimpleMatrixVisualizer spatialActivation;
	...
	private SimpleMatrixVisualizer rsomActivation1;
	private SimpleMatrixVisualizer rsomActivation2;
	private SimpleMatrixVisualizer rsomActivation3;
	private SimpleMatrixVisualizer rsomActivation4;
	
	private int singleSomModelWidth;
	
	public CopyOfMovingLinesGUI(ISomBasics spatialSom, ISomBasics possibleInputsSom) {
		...
		//Add input area
		input = new SimpleMatrixVisualizer(new SimpleMatrix(singleSomModelWidth, singleSomModelWidth), true);
		...
		spatialActivation = new SimpleMatrixVisualizer(new SimpleMatrix(5, 5), true);
		...
		rsomActivation1 = new SimpleMatrixVisualizer(new SimpleMatrix(1, 1), true);
		rsomActivation1.setSize(somPanelSize, somPanelSize);
		add(rsomActivation1);
		
		rsomActivation2 = new SimpleMatrixVisualizer(new SimpleMatrix(1, 1), true);
		...
		//Add two of the RSOM activation cells
		rsomActivation3 = new SimpleMatrixVisualizer(new SimpleMatrix(1, 1),true);
		rsomActivation3.setSize(somPanelSize, somPanelSize);
		add(rsomActivation3);
		
		rsomActivation4 = new SimpleMatrixVisualizer(new SimpleMatrix(1, 1),true);
